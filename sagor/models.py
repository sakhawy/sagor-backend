...
class Package(models.Model):
    ...
    status = models.CharField(max_length=250, choices=Status.choices, default=Status.OK)
...
class Pump(models.Model):
    ...
    status = models.CharField(
        max_length=250, choices=Status.choices, default=Status.INACTIVE
    )
...
class BaseSensor(models.Model):
    ...
    package = models.ForeignKey(
        "Package", on_delete=models.CASCADE, related_name="sensors"
    )
